...
3. Вёрстка соответствует макету **+54**  
   ...
   - блок '<footer>' +8:
      ...
      - В футере ссылка 'The Rolling Scopes School' ведет на страницу курса https://rs.school/js-stage0/
